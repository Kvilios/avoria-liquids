...
<body class="{block name="frontend_index_body_classes"}{strip}
    ...
    {block name="frontend_index_page_wrap"}
        <div class="page-wrap">
            ...
            {block name='frontend_index_navigation'}
                <header class="header-main">
                    ...
                    {/block} *}
                     ...
                     {* {block name='frontend_index_header_custom'}
                        {include file='frontend/index/header-content.tpl'}
                    {/block}  *}
                </header>
            ...
            {* Main carousel block *}
            {block name="frontend_index_banner_carousel"}
                {include file='frontend/index/main-carousel.tpl'}
            {/block}
            {* Advantages block *}
            {block name="frontend_index_advantages"}
                    {include file='frontend/index/advantages.tpl'}
            {/block}
            
            
            {block name='frontend_index_content_main'}
                <section class="{block name="frontend_index_content_main_classes"}content-main block-group{/block}">
            ...
            {block name="frontend_index_about_us"}
                    {include file='frontend/index/map-contacts.tpl'}
            {/block}

            {* Footer *}
            {block name="frontend_index_footer"}
                <footer class="footer-main p-5">
                    <div class="container">
